...
public class Monster {
    ...
    public Monster(String monsterName, String type, int levelRequirement, int hp, int atk, int def, 
                   String hpIndicator, String atkIndicator, String defIndicator, int accuracy, 
                   int escapePrecentage, int moneyLoot, int fragmentLoot, int expLoot, 
                   String uniqueSkill, int cooldownSkill) {
    ...
    public void useSkill() {
        // Implementasi skill monster
    }

    public void itemDrop() {
        // Implementasi item drop
    }

    public void cdSkill() {
        // Implementasi cooldown skill
    }
